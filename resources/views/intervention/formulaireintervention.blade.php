...
@if(session()->has("success"))
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Intervention') }}</div>
...
<!--type-->
                        <div class="row mb-3">
                            <label for="type" class="col-md-4 col-form-label text-md-end">{{ __('Type intervention') }}</label>
                            <div class="col-md-6">
...
<!--lieu-->
                        <div class="row mb-3">
                            <label for="lieu" class="col-md-4 col-form-label text-md-end">{{ __('Lieu Intervention') }}</label>
...
<!--genre-->
<div class="row mb-3">
                            <label for="genre" class="col-md-4 col-form-label text-md-end">{{ __('Genre Intervention') }}</label>
