  ...
  <!--<section class="welcome_section layout_padding">
    <div class="container-fluid">
      <div class="row">
        <div class=" col-md-6">
          <div>
            <img class="img-fluid" src="images/impo3.jpg" alt="" />
          </div>
        </div>
        <div class=" col-md-6">
...
@if(session()->has("success"))
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-heade-delit">{{ __('DENONCER UN DELIT') }}</div>
...
<!--type-->
                        <div class="row mb-3">
                            <label for="type" class="col-md-4 col-form-label text-md-end">{{ __('Quel type de delit') }}</label>
                            <div class="col-md-6">
...
<!--lieu-->
                        <div class="row mb-3">
                            <label for="lieu" class="col-md-4 col-form-label text-md-end">{{ __('Où se passe le delit') }}</label>
...
<!--ampleur-->
<div class="row mb-3">
                            <label for="ampleur" class="col-md-4 col-form-label text-md-end">{{ __('Quelle ampleur a le delit') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn-btn-delit">
                                    {{ __('DENONCER') }}
                                </button>
                            </div>
                        </div>
