    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('arrondissement.create') }}">
                        @csrf
...
<!--num.arrond-->
                        <div class="row mb-3">
                            <label for="numero_arrondissement" class="col-md-4 col-form-label text-md-end">{{ __('Arrondissement') }}</label>

                            <div class="col-md-6">
                                <input id="numero_arrondissement" type="text" class="form-control @error('numero_arrondissement') is-invalid @enderror" name="numero_arrondissement" value="{{ old('numero_arrondissement') }}" required autocomplete="numero_arrondissement" autofocus>
